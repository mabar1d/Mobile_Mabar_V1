...
public class ListMemberTeamTournamentAdapter extends RecyclerView.Adapter<ListMemberTeamTournamentAdapter.TournamentViewHolder> {
    private Context context;
    private List<GetListTournamentResponseModel.Data> dataTournament = new ArrayList<>();
    private GlobalMethod globalMethod;

    public ListMemberTeamTournamentAdapter(Context context, List<GetListTournamentResponseModel.Data> dataTournament) {
    ...
    public TournamentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_host_tournament,parent,false);
